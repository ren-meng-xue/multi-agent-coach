...
```bash
cd backend && .venv/bin/python -m ruff check app/agents-1/prepare/state.py
cd backend && .venv/bin/python -m mypy app/agents-1/prepare
```
...
```bash
git add backend/app/agents-1/prepare/state.py
